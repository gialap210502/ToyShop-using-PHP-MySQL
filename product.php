...
<button class="btn">
     <span class="btn btn-primary">
         <a class="nav-link" style="color: white; font-family: fantasy; font-size: 20px;" href="<?php echo "?page=".$find; ?>">
            Find
        </a>
    </span>
</button>
 <div class="container">
    <?php
        $counter = 0;
        $sql = "select a.*,b.* from products as a left join category as b on a.CAT_ID = b.CAT_ID";
